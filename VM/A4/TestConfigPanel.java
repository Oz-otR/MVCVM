...
public class TestConfigPanel {
	...
	/**
	 * Method to test if the rack was not entered and just pressing enter doesn't
	 * change the modes of config panel. and displays message
	 */
	@Test
	...
	/**
	 * Method to test entering the price for selected rack will change the stage of
	 * config panel.
	 */
	@Test
	...
	/**
	 * Method to test if not entering the price will not change the mode of config
	 * panel.
	 */
	@Test
	...
	/**
	 * Method to test if the technician choose not to change the Name of the rack,
	 * logic will use the previous one it had.
	 */
	@Test
	...
	/**
	 * Method to test discarding the changes, and going back to rackSelectMode which is
	 * selecting the rack num.
	 */
	@Test
	...
	/**
	 * Method to test pressing disable config button ('^' which is the shift key) in
	 * the middle of changing stage.
	 */
	@Test
